...
public class ClienteController {
    ...
    //         return responseEntity;
    //     }
    //     // Si no hay erroes, entonces persistimos el cliente
    ...
    public ResponseEntity<String> delete(@PathVariable(name = "id") Integer id) {
        ...
        //Que la fecha de alta no sea superior a la fecha actual

        public ResponseEntity<String> crearCliente(@Valid @RequestBody Cliente cliente) {
            LocalDate hoy = LocalDate.now();
            if (cliente.getFechaAlta().isAfter(hoy)) {
                return ResponseEntity.badRequest().body("La fecha de alta no puede ser posterior a la fecha actual");
            }
